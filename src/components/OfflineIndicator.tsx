...
function ReconnectedBanner() {
  return (
    <div className="flex items-center gap-3 px-4 py-3 bg-green-500 text-white rounded-lg shadow-lg animate-fade-in">
...
function SyncingBanner({
  ...
  return (
    <div className="flex items-center gap-3 px-4 py-3 bg-[#1A1A1A] text-white rounded-lg shadow-lg">
