...
import { X, Send, Loader2, Mail, Plus, Trash2, FileText, AlertCircle } from 'lucide-react';
...
export function SendQuoteModal({
  ...
  // Initialize with contact email if available
  useEffect(() => {
    if (isOpen && quote) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-xl bg-white rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 flex flex-col max-h-[90vh]">
        {/* Header */}
